(function () {
  ...
  style.textContent = [
    ...
    ".review-nav-status{margin-left:auto!important;padding:2px 6px;border-radius:999px;font-size:8px!important;font-weight:700}.review-nav-status.approved{background:#dcf7e7;color:#147a41}.review-nav-status.rejected{background:#ffe2df;color:#b42318}.review-nav-status.pending{background:#eceff3;color:#6b7280}",
