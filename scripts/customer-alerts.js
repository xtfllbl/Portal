(function () {
  ...
  const monitoringHierarchy = window.PaywizardCustomerAccountData.createHierarchy();
  ...
  const demoRules = [
    ...
    { id: "r-stock", condition: "machine_stock", targetType: "Terminal", targetId: "WP6267UQ36002376", targetName: "Midtown Cooler 01", criteria: "Machine stock below 25% PAR", recipients: ["Portal Inbox", "ops@merchant.example"], channels: ["Portal Inbox", "Email"], status: "Active", modified: "2026-08-27 16:20", owner: "Midtown Store", ownerType: "Store", ownerId: "s-midtown", parameters: { threshold: 25 }, recoveryChecksRequired: 2 },
    { id: "r-merchant-no-transaction", condition: "no_approved_transaction", targetType: "Terminal", targetId: "WP6267UQ36002376", targetName: "Midtown Cooler 01", criteria: "No approved transaction for 2 hours", recipients: ["Portal Inbox"], channels: ["Portal Inbox"], status: "Active", modified: "2026-08-27 14:12", owner: "1 of a Kind World Travel LLC", parameters: { duration: 2 }, recoveryChecksRequired: 2 },
    { id: "r-merchant-temp-range", condition: "temperature_range", targetType: "Terminal", targetId: "WP6267UQ36002376", targetName: "Midtown Cooler 01", criteria: "Outside 2–8 °C", recipients: ["Portal Inbox", "facilities@merchant.example"], channels: ["Portal Inbox", "Email"], status: "Active", modified: "2026-08-27 11:45", owner: "1 of a Kind World Travel LLC", parameters: { lower: 2, upper: 8, unit: "C" }, recoveryChecksRequired: 2 },
    { id: "r-merchant-any-bin", condition: "any_bin", targetType: "Terminal", targetId: "WP6267UQ36002376", targetName: "Midtown Cooler 01", criteria: "Any BIN below 2 units", recipients: ["Portal Inbox"], channels: ["Portal Inbox"], status: "Active", modified: "2026-08-26 17:20", owner: "1 of a Kind World Travel LLC", parameters: { threshold: 2 }, recoveryChecksRequired: 2 },
    { id: "r-merchant-selected-product", condition: "selected_product", targetType: "Terminal", targetId: "WP6267UQ36002376", targetName: "Midtown Cooler 01", criteria: "A1 · Sparkling Water below 30% PAR", recipients: ["Portal Inbox", "stock@merchant.example"], channels: ["Portal Inbox", "Email"], status: "Paused", modified: "2026-08-26 13:05", owner: "1 of a Kind World Travel LLC", parameters: { product: "A1 · Sparkling Water", threshold: 30 }, recoveryChecksRequired: 2 }
  ];
  ...
  const demoIncidents = [
    demoIncident({ id: "i-mid-01", ruleId: "r-merchant-no-transaction", monitoringState: "Active", condition: "no_approved_transaction", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store", evidence: "Last approved transaction 3h 18m ago", opened: "2026-08-28 07:24", duration: "3h 18m", nextChecks: ["normal", "normal"] }),
    demoIncident({ id: "i-mid-02", ruleId: "r-stock", monitoringState: "Active", condition: "machine_stock", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store", evidence: "On Hand 18 / PAR 24 · 75%", opened: "2026-08-28 06:52", duration: "3h 50m", acknowledgedAt: "2026-08-28 07:05", acknowledgedBy: "Alex Morgan", nextChecks: ["normal", "abnormal", "normal", "normal"] }),
    demoIncident({ id: "i-mid-03", ruleId: "r-merchant-temp-range", monitoringState: "Active", condition: "temperature_range", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store", evidence: "Temperature returned to 6.4 °C", opened: "2026-08-28 05:40", duration: "5h 02m", acknowledgedAt: "2026-08-28 05:51", recoveryHitCount: 1, lastCheckedAt: "2026-08-28 10:30", nextChecks: ["normal"] }),
    demoIncident({ id: "i-mid-04", ruleId: "r-merchant-any-bin", monitoringState: "Resolved", condition: "any_bin", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store", evidence: "BIN B1 replenished to 6 units", opened: "2026-08-27 19:10", duration: "1h 06m", acknowledgedAt: "2026-08-27 19:18", recoveryHitCount: 2, recoveredAt: "2026-08-27 20:16", nextChecks: [] }),
    demoIncident({ id: "i-mid-05", ruleId: "r-merchant-selected-product", monitoringState: "Closed", condition: "selected_product", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store", evidence: "A1 · Sparkling Water at 2 / 10 PAR", opened: "2026-08-27 16:35", duration: "18h 07m", acknowledgedAt: "2026-08-27 16:40", closedAt: "2026-08-27 17:02", closedBy: "robasz", closeReason: "Replenishment in progress", closeNote: "Scheduled route arrives this afternoon.", nextChecks: ["normal", "normal"] }),
    demoIncident({ id: "i-mid-06", ruleId: "r-merchant-any-bin", monitoringState: "Active", condition: "any_bin", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store", evidence: "BIN C2 On Hand 1 · threshold 2", opened: "2026-08-28 09:26", duration: "1h 16m", nextChecks: ["abnormal", "normal", "normal"] }),
    demoIncident({ id: "i-mid-07", ruleId: "r-provider-universal", monitoringState: "Resolved", condition: "opc_offline", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store", evidence: "Payment Service available", opened: "2026-08-26 22:10", duration: "38m", recoveryHitCount: 2, recoveredAt: "2026-08-26 22:48", nextChecks: [] }),
    demoIncident({ id: "i-mid-08", ruleId: "r-provider-boston-soldout", monitoringState: "Closed", condition: "sold_out", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store", evidence: "BIN D4 On Hand = 0", opened: "2026-08-26 14:20", duration: "20h 22m", closedAt: "2026-08-26 15:00", closedBy: "Alex Morgan", closeReason: "False positive", closeNote: "BIN removed from the active planogram.", recoveredAt: "2026-08-26 15:30", nextChecks: [] }),
  ...
  [
    ...
    demoIncidents.push(demoIncident({
      ...example, ruleId, monitoringState: "Active", terminalId: "WP6267UQ36002376", terminalName: "Midtown Cooler 01", store: "Midtown Store",
  ...
  function restoreIncidentRules(data) {
    ...
    data.incidents.forEach(incident => {
      ...
      const restored = {
        ...
        targetName: seed?.targetName || incident.terminalName || "",
  ...
  const terminalName = window.terminalContext ? String(window.terminalContext.terminalName || '').trim() : "Midtown Cooler 01";
