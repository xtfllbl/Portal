...
This boundary was confirmed on 2026-09-15. It preserves the meaning of payment relationships across integrations without requiring Paywizard to model retail orders or infer split payments. Existing implementation names such as `orderNo` do not introduce a retail-order domain concept. The Transactions list continues to show individual records with an entry to related records; the detailed viewing scope remains under design.
